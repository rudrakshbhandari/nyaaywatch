# Telangana High Court Source Review

Source review for the Telangana High Court public beta candidate inside NyaayWatch.

This document records the official public-source boundary for Telangana High Court observability as verified on `2026-04-19`.

## Bottom Line

Telangana High Court is viable as a public High Court beta page now that the live internal proof bar is already satisfied.

The correct source boundary remains the same as the first Himachal High Court pilot:

- **canonical aggregate source:** HC NJDG
- **supporting case-level and document link-outs:** High Court Services and the official Telangana High Court site
...
- [Telangana High Court selected page](https://njdg.ecourts.gov.in/hcnjdg_v2/?p=home&state_code=36~29)

Observed role:

- official aggregate High Court dashboard
- selector value for High Court for State of Telangana
...
### 3. Telangana High Court Official Site

Primary URL:

- [Telangana High Court official site](https://tshc.gov.in/)

Observed role:

- official institutional site
- case-information links, annual reports, statistics, and supporting public court materials
- notices, rosters, judgments, and e-services
...
- High Court Services
- Telangana High Court official site

## Metric Boundary

The current public High Court beta contract for Telangana High Court should stay limited to:
...
Proceed with the Telangana High Court public beta using:

- HC NJDG as the stored-evidence aggregate source
- High Court Services and the official Telangana High Court site as public supporting link-outs
