...
- 2026-04-23: Promoted the common High Court of Jammu & Kashmir and Ladakh into the public High Court beta after the recorded proof cycle and source review, and added `docs/INDIA_COURT_COVERAGE_AUDIT.md` to pin the April 2026 official-source coverage boundary: all 25 High Court NJDG selectors are configured, but lower-court coverage still needs 8 Union Territory or UT-style profiles before all-India lower-court comprehensiveness can be claimed.
