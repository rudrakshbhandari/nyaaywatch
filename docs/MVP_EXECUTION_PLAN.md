...
- 2026-04-17: Added `docs/HARYANA_PUBLIC_READINESS_REVIEW.md` to close the Haryana trust-surface review: Haryana is now the next narrow public rollout candidate, and after the later Uttarakhand/Rajasthan/Uttar Pradesh proof cycles the remaining work is Haryana public-route parity plus live rollout verification.
