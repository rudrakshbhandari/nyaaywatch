...
- 2026-04-17: Added `docs/HARYANA_PUBLIC_READINESS_REVIEW.md` to close the Haryana trust-surface review: Haryana is now the next narrow public rollout candidate, but it should remain internal-only until one more internal-only state clears the same live proof cycle and Haryana public-route parity is verified.
