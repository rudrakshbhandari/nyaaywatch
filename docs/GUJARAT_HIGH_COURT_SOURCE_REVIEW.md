# Gujarat High Court Source Review

Source review for the Gujarat High Court public beta candidate inside NyaayWatch.

This document records the official public-source boundary for Gujarat High Court observability as verified on `2026-04-19`.

## Bottom Line

Gujarat High Court is viable as a public High Court beta page now that the live internal proof bar is already satisfied.

The correct source boundary remains the same as the first Himachal High Court pilot:

- **canonical aggregate source:** HC NJDG
- **supporting case-level and document link-outs:** High Court Services and the official Gujarat High Court site
...
- [Gujarat High Court selected page](https://njdg.ecourts.gov.in/hcnjdg_v2/?p=home&state_code=24~17)

Observed role:

- official aggregate High Court dashboard
- selector value for High Court of Gujarat
...
### 3. Gujarat High Court Official Site

Primary URL:

- [Gujarat High Court official site](https://gujarathighcourt.nic.in/)

Observed role:

- official institutional site
- case-information links, annual report access, and institution or disposal or pendency reports
- notices, calendars, rules, and supporting public court materials
...
- High Court Services
- Gujarat High Court official site

## Metric Boundary

The current public High Court beta contract for Gujarat High Court should stay limited to:
...
Proceed with the Gujarat High Court public beta using:

- HC NJDG as the stored-evidence aggregate source
- High Court Services and the official Gujarat High Court site as public supporting link-outs
