...
vi.mock("../src/dev/high-court-readiness-verification.js", () => ({
  verifyHighCourtInternalReadiness: vi.fn(async (_baseUrl: string, _operatorToken: string, options: { courtSlug: string; now?: Date }) => ({
    ...
    target: {
      ...
      coveredGeographies: [{ geographyCode: "XX", geographyName: "Example", geographyType: "state", lowerCourtStateCode: "XX" }],
    ...
    internalEvidence: {
      ...
      latestRunScopeType: options.courtSlug === "rajasthan" ? null : "high_court",
      latestRunScopeCode: options.courtSlug === "rajasthan" ? null : options.courtSlug.toUpperCase(),
      latestPublicationId: null,
      latestPublicationScopeType: options.courtSlug === "rajasthan" ? null : "high_court",
      latestPublicationScopeCode: options.courtSlug === "rajasthan" ? null : options.courtSlug.toUpperCase(),
    ...
    gates: {
      ...
      canonicalScopeAligned: options.courtSlug !== "rajasthan",
