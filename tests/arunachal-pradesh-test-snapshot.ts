    ...
    districts: [
      {
        ...
        summary:
          "Lohit has 1,984 cases waiting. A typical pending case falls around 183 days old, and the district cleared 91.2% as many cases as it received last month. It stays on the watchlist in this snapshot.",
      },
      {
        ...
        summary:
          "Papum Pare has 2,436 cases waiting. A typical pending case falls around 365 days old, and the district cleared 126.7% as many cases as it received last month. It stays on the watchlist in this snapshot.",
      },
      {
        ...
        summary:
          "Changlang has 1,763 cases waiting. A typical pending case falls around 183 days old, and the district cleared 97.4% as many cases as it received last month. It stays on the watchlist in this snapshot.",
      },
    ],
    trends: [
      {
