...
- [ ] Run source review plus `npm run high-court:wave-readiness -- --base-url=https://nyaaywatch.in --court-slugs=sikkim,tripura` for the newly chosen Sikkim plus Tripura pair before deciding whether any court deserves the next public High Court wave after the current seven-court beta.
