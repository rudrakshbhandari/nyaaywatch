...
- [ ] Run source review plus `npm run high-court:wave-readiness -- --base-url=https://nyaaywatch.in --court-slugs=meghalaya,manipur` for the newly chosen Meghalaya plus Manipur pair before deciding whether any court deserves the next public High Court wave after the current seven-court beta.
