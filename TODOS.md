...
- [ ] Run source review plus `npm run high-court:wave-readiness -- --base-url=https://nyaaywatch.in --court-slugs=bihar,uttarakhand` for the newly chosen Bihar plus Uttarakhand pair before deciding whether any court deserves the next public High Court wave after the current seven-court beta.
