...
- [ ] Run at least one additional live Supreme Court operator proof cycle through the internal `/operator/supreme-court/...` namespace so the evidence spans separate windows before any public Supreme Court route ships.
